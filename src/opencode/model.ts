...
export interface OpenCodeParseDiagnostic {
...
export interface ParsedOpenCodeSession {
...
export interface SkillLoadObservation {
  skillName?: string;
  partId?: string;
  callId?: string;
  messageId?: string;
...
export interface NormalizedOpenCodeSession {
  id?: string;
  parentId?: string;
  title: string;
  version?: string;
  ...
  rootNodeId: string;
  rawByReference: Map<string, unknown>;
  messages: ParsedMessage[];
