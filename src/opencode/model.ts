...
export interface TrajectoryNode { id: string; kind: NodeKind; parentId?: string; sourceOrder: number; label: string; description?: string; start?: number; end?: number; durationMs?: number; status?: string; toolName?: string; skillName?: string; children: string[]; preview?: string; rawReference?: string; synthetic?: boolean; incomplete?: boolean; originalType?: string }
